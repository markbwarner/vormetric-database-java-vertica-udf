...
CREATE LIBRARY JavaScalarFunctions AS :libSfile  DEPENDS '/opt/vertica/bin/asm-1.0.2.jar:/opt/vertica/bin/commons-codec-1.7.jar:/opt/vertica/bin/commons-lang-2.6.jar:/opt/vertica/bin/javax.ws.rs-api-2.0-m10.jar:/opt/vertica/bin/json-path-0.8.1.jar:/opt/vertica/bin/json-smart-2.1.0.jar' LANGUAGE 'JAVA';
